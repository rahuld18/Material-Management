		 ...
		 out.println("<html>");
	       try{
	    	   ...
	    	   if(rs.next())
	    	   {
	    		   ...
	    		   do{
	    			   out.println("<tr><td>Id:"+rs.getString(1)+"<br>"+"<img width=45 height=45 src=/MM/eimages/"+rs.getString(19)+"><br>"+rs.getString(2)+"<br>F'Name:"+rs.getString(3)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(4)+"</br></td><td>"+rs.getString(6)+"<br>"+rs.getString(8)+","+rs.getString(7)+"</td><td>"+rs.getString(9)+"<br>"+rs.getString(11)+","+rs.getString(10)+"</td><td>Ph:"+rs.getString(12)+"<br>Mob:"+rs.getString(13)+"<br>Mail:"+rs.getString(14)+"</td><td>"+rs.getString(15)+"<br>"+rs.getString(16)+"</br>"+rs.getString(17)+"</td><td><a href=DisplayEmployeeById?eid="+rs.getString(1)+">Edit/Delete</a></td></tr>");
