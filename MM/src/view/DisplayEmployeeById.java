	    ...
	    ResultSet rs=EmployeeController.displayById(Integer.parseInt(request.getParameter("eid")));
	    	 if(rs.next())
	    	 {
	    		 out.println("<form action='#' method='post' enctype='multipart/form-data'>");
                  ...
                  out.println("<tr><td><b><i>State:["+rs.getString(7)+"] </b></i> <input type=hidden  name=oldpstate value='"+rs.getString(20)+"' /></td><td><select name='epst' id='epst'></select></td></tr>");
	    			
                  out.println("<tr><td><b><i>City:["+rs.getString(8)+"]</b></i> <input type='hidden' name='oldpcity' value='"+rs.getString(21)+"'></td><td><select name='epct' id='epct'><option>-city-</option></select></td></tr>");
	    			
	    			out.println("<tr><td><b><i>Current<br>Address:</b></i></td><td><textarea name='epca' rows='3' cols='25'></textarea></td></tr>");
	    			out.println("<tr><td><b><i>State:</b></i></td><td><select id='ecst' name='ecst'></select></td></tr>");
	    			out.println("<tr><td><b><i>City:</b></i></td><td><select id='ecct' name='ecct'><option>-City-</option></select></td></tr>");
